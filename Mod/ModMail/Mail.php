           ...
           <tr>
			...
			<tr>
                ...
                <td>
					...
					<small><i>Pengisian No. Agenda Setelah No. Agenda Terakhir</strong></i></small>                </td>
            </tr>
    	...
    	<table cellspacing="2" cellpadding="2" style="width:100%">
            ...
            <tr style="display:<?php echo $viewPenerima; ?>">
                ...
                <td style="width:65%;">
                    ...
                    <input type="text" style="width: 400px; height: " name="txt_kepada" id="txt_kepada" class="inputbox" value="<?php echo $_SESSION["txt_kepada"]; ?>"/>
            ...
            <tr id="trTembusan" style="display:<?php echo $viewPenerima; ?>">
                <td valign="top">
                    Tembusan</td>
                <td><input type="text" id="txt_CC" name="txt_CC" class="inputbox" style="width:400px;" />
					<br /><br />
					&nbsp;
