	...
	<table cellspacing="0" cellpadding="3px" width="100%">
		...
		<tr>
			...
			<td style="width:80%;" class="tabel-upload-content">
				<input type="hidden" name="txt1" value="<?php echo $row["RoleId"]; ?>" />
				<select name="txt2">
					<?php
		...
		<tr>
			...
			<td class="tabel-upload-content"><?php echo $row["BerkasNumber"] . " - " . $row["BerkasName"]; ?></td>
		</tr>
		<tr>
			<td class="tabel-upload-label">Retensi</td>
			<td class="tabel-upload-content">Perhitungan Dimulai dari : 
				<?php 	if($row["BerkasCountSince"] == "created"){
		...
		<tr>
			...
			<td class="tabel-upload-content">
				<input type="text" name="txt3" style="width:75%;" value="<?php echo $row["BerkasLokasi"]; ?>" />&nbsp;
		...
		<tr>
			<td style="text-align:right;">
				...
				<input type="hidden" name="id" value="<?php echo $BerkasId; ?>" />
